    ...
    <div className={classes.root}>
      {isMobile ? (
        ...
        <div>
          ...
          {r.userName ? (
            ...
            <Login onClick={()=>router.push("/community")} className={classes.menuButton}>
             Community
           </Login>
      ...
      <div className={classes.stack}>
        <h1 className={classes.tagLine}>
          Invest in Songs from your favourite Artists.
        </h1>
        <h4 className={classes.subTitle}>Earn Royalty & more.</h4>
        <EarlyAccess />
      </div>
      <LoginScreen open={open} onClose={handleClose} />
    </div>
  );
}
